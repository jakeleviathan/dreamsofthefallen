...
description = [[
# Dreams of the Fallen Official HUD 2.2.3
...
- tabbed active-effects, party, quest, and inventory panels with a scrollable large-inventory Pack view and clickable item inspection
