...
- item-first timed crafting display in the existing bottom HUD strip, with the crafted item visually dominant and progress driven by structured GMCP instead of terminal redraw escape sequences
