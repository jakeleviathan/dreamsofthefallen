...
description = [[
# Dreams of the Fallen Official HUD 2.2.7
...
- tabbed active-effects, party, quest, and inventory panels with larger high-contrast quest text, a scrollable large-inventory Pack view, and clickable item inspection
