...
# Register 90 deliberately memorable world objects. The internal catalog knows
# they are design anchors, but the player-facing game never labels them "iconic";
# their reputations are meant to emerge from utility, rarity, names, and stories.
