...
class PlayerSession:
    ...
    async def playing_prompt(self) -> None:
        ...
        if verb in {"help", "?"}:
            await self.send(
                "Commands: LOOK [target], APPEARANCE, EXITS, NORTH/SOUTH/EAST/WEST/NORTHEAST/NORTHWEST/SOUTHEAST/SOUTHWEST, SCORE, STATS, HEALTH, LORE, SKILLS, ABILITIES, ABILITIES ALL, "
