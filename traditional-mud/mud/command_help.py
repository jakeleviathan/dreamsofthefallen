...
def _full_help_text(session) -> str:
    ...
    lines.extend(
        [
            ...
            "BUY [qty] <item> - purchase merchant stock with Sols",
            "SELL [qty] <item> - sell carried, unequipped items at merchant buyback value",
            "VALUE <item> - ask what a nearby merchant would pay",
            "",
            "[Community Support & Cosmetics]",
            "VOTE - show the MUDVerse voting link and arm an account-wide vote claim",
            "VOTE CLAIM - check a pending vote and claim its daily reward",
            "ECHOES - show Echoes of Favour, active title, aura, and sigil",
            "ECHOES SHOP / ECHOES BUY <name> - browse and unlock cosmetic presentation rewards",
            "TITLES / TITLE SET <name> / TITLE CLEAR - manage an unlocked displayed title",
            "COSMETICS / COSMETIC SET <name> / COSMETIC CLEAR AURA|SIGIL - manage Echo cosmetics",
            "",
            "[Time & World]",
