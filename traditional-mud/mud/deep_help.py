...
EXTRA_COMMANDS: tuple[CommandEntry, ...] = (
    ...
    CommandEntry("combat", "HUNT / HUNT STATUS", "Read the local hunting ground and your current combat momentum.", ("hunting", "grind", "chain", "momentum")),
    CommandEntry("character", "DROP <item> / DROP <quantity> <item>", "Leave carried items on the ground in your current room.", ("ground", "discard", "leave")),
    CommandEntry("character", "GET / TAKE <ground item>", "Pick up an ordinary item lying on the room floor.", ("pickup", "ground")),
    CommandEntry("combat", "LOOT CORPSE / LOOT <enemy>", "Take every corpse drop currently assigned or available to you.", ("corpse", "drops", "remains")),
    CommandEntry("combat", "GET / TAKE ALL FROM <corpse or enemy>", "Take all available loot from a defeated enemy corpse.", ("corpse", "loot", "drops")),
    CommandEntry("combat", "GET / TAKE <item> FROM <corpse or enemy>", "Take a particular corpse drop, optionally with a quantity.", ("corpse", "loot", "item")),
    CommandEntry("combat", "LOOK / EXAMINE CORPSE", "Inspect a corpse, its drops, protection state, and remaining loot.", ("corpse", "body", "remains")),
    CommandEntry("combat", "CORPSES", "List persistent defeated-enemy remains in the current room.", ("bodies", "remains")),
    CommandEntry("character", "RACIAL", "Show your racial passive, active ability, and cooldown state.", ("race", "racial ability", "passive")),
    CommandEntry("character", "ADAPT MIGHT|GRACE|LOVE|MIND", "Use the Human Adapt racial ability.", ("human", "racial")),
    CommandEntry("character", "SLIPSTEP", "Use the Forest Elf Slipstep racial ability.", ("forest elf", "racial")),
    CommandEntry("character", "RECONSIDER", "Use the Moon Elf Reconsider racial ability.", ("moon elf", "racial")),
    CommandEntry("character", "SCROUNGE", "Use the Goblin Scrounge racial ability.", ("goblin", "racial")),
    CommandEntry("character", "BLOODSCENT", "Use the Troll Bloodscent racial ability.", ("troll", "racial")),
    CommandEntry("character", "STILLNESS", "Use the Undead Stillness racial ability.", ("undead", "racial")),
    CommandEntry("character", "CHORUS BLOOM", "Use the Sporekin Chorus Bloom racial ability.", ("sporekin", "racial")),
    CommandEntry("settings", "SETTINGS / PREFERENCES / ACCESSIBILITY", "Open persistent player presentation and accessibility settings.", ("preferences", "accessibility")),
    CommandEntry("settings", "PROMPT QUIET|COMPACT|FULL", "Choose and save gameplay prompt detail.", ("prompt", "hud")),
    CommandEntry("settings", "SET COLOR AUTO|ON|OFF", "Choose ANSI color behavior.", ("ansi", "color")),
    CommandEntry("settings", "SET CONTRAST STANDARD|HIGH", "Choose standard or high-contrast presentation.", ("contrast", "accessibility")),
    CommandEntry("settings", "SET HINTS OFF|GENTLE|FULL", "Choose how much automatic guidance the game provides.", ("hints", "guidance")),
    CommandEntry("settings", "SET MUDLET ON|OFF", "Enable or disable server-supplied Mudlet HUD and GMCP enhancements.", ("mudlet", "gmcp", "client")),
    CommandEntry("settings", "SET SCREENREADER ON|OFF", "Enable or disable the plain screen-reader presentation mode.", ("screen reader", "accessibility")),
    CommandEntry("settings", "SETTINGS RESET", "Restore the recommended default presentation settings.", ("preferences", "defaults")),
