...
CONTENT_BANDS: tuple[ContentBand, ...] = (
    ...
    ContentBand(
        ...
        (
            "Thornwake Troll country",
            "Deepwheel Dwarven corridor",
            "Counterstar Moon Elf highroad",
            "Blackglass Human march",
            "Alderwake Forest Elf road",
            "Rattlechain Goblin run",
            "Pale Undead road",
            "Rainroot Sporekin threadway",
        ),
    ),
